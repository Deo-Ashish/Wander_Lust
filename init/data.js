const sampleListings = [
  ...
  },
  {
    ...
    geometry: { type: "Point", coordinates: [-4.2026, 57.1206] },
    category: "castles",
  },
  {
  ...
  // --- Indian Listings ---
  {
    ...
    description: "Drift through the serene backwaters of Kerala on a traditional kettuvallam houseboat.",
    ...
    price: 3500, location: "Alleppey", country: "India",
    geometry: { type: "Point", coordinates: [76.3388, 9.4981] },
    category: "boats",
  },
  {
    title: "Heritage Haveli in Jaisalmer",
    description: "Stay in a royal sandstone haveli in the heart of the Golden City. Enjoy rooftop views of the Jaisalmer Fort.",
    ...
    price: 4500, location: "Jaisalmer", country: "India",
    geometry: { type: "Point", coordinates: [70.9083, 26.9157] },
    category: "castles",
  },
  {
    title: "Tea Estate Bungalow in Munnar",
    description: "Wake up to misty mountains and endless tea gardens in this colonial-era planter's bungalow.",
    image: { filename: "listingimage", url: "https://images.unsplash.com/photo-1566552881560-0be862a7c445?auto=format&fit=crop&w=800&q=60" },
    price: 2800, location: "Munnar", country: "India",
    geometry: { type: "Point", coordinates: [77.0595, 10.0889] },
    category: "mountains",
  },
  {
    title: "Riverside Cottage in Rishikesh",
    description: "A peaceful cottage on the banks of the Ganges, perfect for yoga, meditation, and white-water rafting.",
    image: { filename: "listingimage", url: "https://images.unsplash.com/photo-1591017403286-fd8493524e1e?auto=format&fit=crop&w=800&q=60" },
    price: 2000, location: "Rishikesh", country: "India",
    geometry: { type: "Point", coordinates: [78.2676, 30.0869] },
    category: "camping",
  },
  {
    title: "Luxury Tent in Rann of Kutch",
    description: "Experience the magical white salt desert under a canopy of stars. Luxury Swiss tents with modern amenities.",
    ...
    price: 5000, location: "Rann of Kutch", country: "India",
    geometry: { type: "Point", coordinates: [69.7595, 23.7337] },
    category: "domes",
  },
  {
    title: "Colonial Villa in Pondicherry",
    description: "A charming French colonial villa in the heart of the White Town. Cobblestone streets and the Bay of Bengal nearby.",
    ...
    price: 3200, location: "Pondicherry", country: "India",
    geometry: { type: "Point", coordinates: [79.8083, 11.9416] },
    category: "trending",
  },
  {
    title: "Mountain Homestay in Spiti Valley",
    description: "Stay with a local family in a traditional mud-brick home surrounded by snow-capped Himalayan peaks.",
    ...
    price: 1500, location: "Spiti Valley", country: "India",
    geometry: { type: "Point", coordinates: [78.0322, 32.2461] },
    category: "arctic",
  },
  {
    title: "Beachfront Shack in Goa",
    description: "A laid-back beachfront shack steps away from Palolem Beach. Sunsets, seafood, and Goan nightlife await.",
    image: { filename: "listingimage", url: "https://images.unsplash.com/photo-1587922546307-776227941871?auto=format&fit=crop&w=800&q=60" },
    price: 2200, location: "Goa", country: "India",
    geometry: { type: "Point", coordinates: [74.0855, 15.2993] },
    category: "trending",
  },
];
